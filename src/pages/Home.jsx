...
import { generateHexCode } from '../util/hex-code.ts'
                ...
                <script>
                    if (!localStorage.getItem('user')) {
                        ...
                        fetch('/api/register', {
                            ...
                            .then((res) => {
                                console.info('created new user with id :: ', userId)
                            })
                            .catch((err) => {
                                console.error('error registering user with id :: ', userId)
                            });
                    }
                </script>
            </head>
